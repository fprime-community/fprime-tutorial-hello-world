...
#include <MyNamespace/FirstDeployment/Top/FirstDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    MyNamespace::TopologyState inputs;
    ...
    MyNamespace::setupTopology(inputs);
    MyNamespace::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    MyNamespace::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
